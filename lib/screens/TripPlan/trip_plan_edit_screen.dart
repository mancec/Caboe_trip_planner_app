...
import 'package:canoe_trip_planner/screens/TripPlan/trip_plan_time_edit_screen.dart';
...
class TripPlanEditScreen extends StatefulWidget {
  ...
  TripPlanEditScreen({this.routeId});
  @override
  _TripPlanEditScreenState createState() => _TripPlanEditScreenState();
}
...
class _TripPlanEditScreenState extends State<TripPlanEditScreen> {
  ...
  void initState() {
    ...
    tripPlanProvider.getTripPlan(widget.routeId).then((value) =>
  ...
  saveForm() {
    if (_formKey.currentState.validate()) {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) {
        return TripPlanTimeEditScreen(
          routeId: mapRouteProvider.mapRoute.id,
          description: description,
          tripPlan: tripPlanProvider.tripPlan,
        );
      }));
      // setState(() {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<MapRouteProvider>(
        ...
        child: ChangeNotifierProvider<TripPlanProvider>(
          create: (context) => tripPlanProvider,
          child: Consumer2<MapRouteProvider, TripPlanProvider>(
              builder: (context, route, tripPlanProvider, child) {
            return Scaffold(
