...
class MapRouteDetailSharedScreen extends StatefulWidget {
  static const String id = 'map_route_detail_shared_screen';
  MapRouteDetailSharedScreen({this.mapId});
...
class _MapRouteScreenState extends State<MapRouteDetailSharedScreen> {
